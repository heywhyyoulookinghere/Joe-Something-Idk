...
print(prefix.."moveback -- moves the back divider")
...
game.Players.LocalPlayer.Chatted:connect(function(msg)
if string.sub(msg:lower(), 0, 9) == prefix.."moveback" then wait(.1)
notif("Moving the back divider..")
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(Vector3.new(-26.165, 1.2, -30.946))
wait()
say("sit me")
wait(.9)
say("punish me")
